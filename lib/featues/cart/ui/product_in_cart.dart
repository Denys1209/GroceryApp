      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      fit: BoxFit.cover,
                      image: NetworkImage(widget.model.model.imageUrl))),
            ),
            const SizedBox(
              height: 20,
            ),
            ...
            Text(widget.model.model.category),
            const SizedBox(
              height: 20,
            ),
            Row(
              ...
              children: [
                ...
                Row(
                  children: [
                    IconButton(
                      onPressed: () {
                        widget.homeBloc.add(HomeClickOnAddProductEvent(
                    ...
                    IconButton(
                      onPressed: () {
                        widget.homeBloc.add(HomeClickOnMinusProductEvent(
                          clickedProduct: widget.model,
                          cartBloc: cartBloc,
                        ));
                      },
